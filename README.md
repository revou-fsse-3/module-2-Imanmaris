...
- ***New assagnment task***
    ...
    - [x] Netlify Sign up process & connect Netlify to your Github project.
    - [x] Auto Deployment on Github with Netlify.
    - [x] How to connect your custom domain and Domain Network System.
...
- *<u>Domain Purchase</u>*
    ...
    2. Register first, If you don't have an account, you can 
    register first. This time I already had a registered account, so I choose sign in with google account.
...
- *<u>Domain Name Sytem Settings</u>*
    ...
    <img style="padding-bottom: 2%; padding-top: 3%;" width="100%" src="./assets/image/connect netlify to clodflare.png" alt="connect netlify via cloudflare">

    11. Open and sign in your account in netlify. Select "<b>site overview</b>" and copy url netlify subdomain (*example : verdant-nougat-845e4d.netlify.app*).
    ...
    <b>Type = CNAME ; Name (Required) = @ ; Target (Required) = paste url netlify subdomain (*example : verdant-nougat-845e4d.netlify.app*) </b> and select "<b>save</b>".

    13. Wait for domain name system access until it is approved.

    <img style="padding-bottom: 2%; padding-top: 3%;" width="100%" src="./assets/image/netlify manage domain1.png" alt="copy dns cloudflare ke niagahoster">
    ...
    <img style="padding-bottom: 2%; padding-top: 3%;" width="100%" src="./assets/image/connect netlify with cloudflare2.png" alt="connect netlify with cloudflare2">
...
<h4 align="center">last created on November 10, 2023</h4>
